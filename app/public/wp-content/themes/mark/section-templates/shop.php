...
//Class 2.26
global $mark_section;
$mark_section_meta = get_post_meta( $mark_section['section'], 'mark-section-shop', true );
            ...
            <div class="row justify-content-md-center">
                <div class="col-md-8">
                    <div class="section-title text-center">
                        <h2 class="title ">
                            <?php echo $mark_section_meta['heading']; ?>
                        </h2>
                    </div>
                </div>
                ...
                ?>
                    ...
                    <?php
                        ...
                        while ( $mark_products->have_posts() ):
                            ...
                            $mark_class = $mark_counter % 3 == 0 ? 'last' : '';
                            ?>
                            <li class="product <?php echo esc_attr( $mark_class ); ?>">
                                ...
                                <a href="<?php echo '?add-to-cart=' . get_the_ID(); ?>" class="button add_to_cart_button"><?php _e( 'Add to cart', 'mark' );?></a>
                            </li>
                            <?php
                        endwhile;
                        wp_reset_query();
                    ...
                    <div class="text-center">
                        <a href="<?php echo esc_url( $mark_section_meta['link-url'] ); ?>" class="btn-link"><?php echo esc_html( $mark_section_meta['link-label'] ); ?></a>
                    </div>
                </div>
            </div>
        </div>
