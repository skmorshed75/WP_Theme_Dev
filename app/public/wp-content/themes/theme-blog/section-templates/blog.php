...
if ( count( $posts ) > 0 ):
    $mark_thumbnail = get_the_post_thumbnail_url($_posts[0],'mark-landscape-one');
	?>
    <!--blog section start-->
        ...
        <div class="row">
            <div class="col-md-6 align-self-center">
                ...
                <div class="img-block-txt">
                    ...
                    <h2 class="mb-1">
                        <a href="<?php echo get_the_permalink($_posts[0]); ?>">
                            <?php echo esc_html($_posts[0]->post_title); ?>
                        </a>
                    </h2>
                    <div class="meta mb-4">
	                    ...
	                    <?php _e( 'By', 'mark' ); ?>
                        <a href="<?php echo get_the_permalink($_posts[0]); ?>">
                            <?php echo get_the_author_meta('display_name',$_posts[0]->post_author) ?>
                        </a>
                    </div>
                    <p>
                        <?php echo apply_filters('the_content',$_posts[0]->post_excerpt); ?>
                    </p>
